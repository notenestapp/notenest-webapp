...
const Footer = () => {
  const socialLinks = [
    {
      name: "TikTok",
      href: "https://www.tiktok.com/@notenest_app",
      icon: (
    ...
    {
      name: "Instagram",
      href: "https://www.instagram.com/notenest.app/",
      icon: (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "YouTube",
      href: "https://www.youtube.com/@notenest_app",
      icon: (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
    ...
    {
      name: "Facebook",
      href: "https://www.facebook.com/profile.php?id=61579234088367",
      icon: (
        <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
